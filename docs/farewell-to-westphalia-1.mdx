...
<div className='ftw-links'>
  <a onClick={() => umami.track('Farewell to Westphalia  - Physical edition', { source: '/farewell-to-westphalia-1' })} href="https://www.amazon.com/Farewell-Westphalia-Sovereignty-Post-Nation-State-Governance/dp/B0FQLV79ZN/ref=tmm_pap_swatch_0" target="_blank" rel="noopener noreferrer">
    <Button>Physical edition</Button>
  </a>

  <a onClick={() => umami.track('Farewell to Westphalia  - Kindle edition', { source: '/farewell-to-westphalia-1' })} href="https://www.amazon.com/Farewell-Westphalia-Sovereignty-Post-Nation-State-Governance-ebook/dp/B0FMGNN2ZT/ref=tmm_kin_swatch_0" target="_blank" rel="noopener noreferrer">
    <Button>Kindle edition</Button>
  </a>

  <a onClick={() => umami.track('Farewell to Westphalia  - Open-source edition', { source: '/farewell-to-westphalia-1' })} href="/assets/Farewell to Westphalia (Jarrad Hope and Peter Ludlow) - FOSS edition.pdf" target="_blank" rel="noopener noreferrer">
    <Button>Open-source edition</Button>
  </a>

  <a onClick={() => umami.track('Farewell to Westphalia  - Academic discounts and all enquiries', { source: '/farewell-to-westphalia-1' })} href="mailto:pressengine@logos.co" target="_blank" rel="noopener noreferrer">
