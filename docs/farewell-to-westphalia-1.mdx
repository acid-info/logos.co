...
<div className='ftw-links'>
  ...
  <a onClick={() => umami.track('Farewell to Westphalia  - Barnes & Noble', { source: '/farewell-to-westphalia-1' })} href="https://www.barnesandnoble.com/w/farewell-to-westphalia-jarrad-hope/1148269022" target="_blank" rel="noopener noreferrer">
  ...
  <a onClick={() => umami.track('Farewell to Westphalia  - Open source (free)', { source: '/farewell-to-westphalia-1' })} href="/assets/Farewell to Westphalia (Jarrad Hope and Peter Ludlow) - FOSS edition.pdf" target="_blank" rel="noopener noreferrer">
    <Button>Open source (free)</Button>
  </a>
</div>
...
<div className='ftw-links'>
  <a onClick={() => umami.track('Farewell to Westphalia  - Kindle', { source: '/farewell-to-westphalia-1' })} href="https://kdp.amazon.com/amazon-dp-action/us/dualbookshelf.marketplacelink/B0FMGNN2ZT" target="_blank" rel="noopener noreferrer">
    <Button>Kindle</Button>
  </a>
  <a onClick={() => umami.track('Farewell to Westphalia  - Everand', { source: '/farewell-to-westphalia-1' })} href="https://www.everand.com/book/919673671/Farewell-to-Westphalia-Crypto-Sovereignty-and-Post-Nation-State-Governance" target="_blank" rel="noopener noreferrer">
    <Button>Everand</Button>
  </a>
  <a onClick={() => umami.track('Farewell to Westphalia  - Rakuten', { source: '/farewell-to-westphalia-1' })} href="https://books.rakuten.co.jp/rk/075784a5d8dd32059795a86a31e787f7/" target="_blank" rel="noopener noreferrer">
    <Button>Rakuten</Button>
  </a>
</div>
...
<div className='ftw-links'>
  <a onClick={() => umami.track('Farewell to Westphalia  - Walmart', { source: '/farewell-to-westphalia-1' })} href="https://www.walmart.com/ip/Farewell-to-Westphalia-Crypto-Sovereignty-and-Post-Nation-State-Governance-Paperback-9783952627518/17787172783" target="_blank" rel="noopener noreferrer">
    <Button>Walmart</Button>
  </a>
  <a onClick={() => umami.track('Farewell to Westphalia  - Germany', { source: '/farewell-to-westphalia-1' })} href="https://www.hugendubel.de/de/buch_kartoniert/jarrad_hope_peter_ludlow-farewell_to_westphalia-51723009-produkt-details.html" target="_blank" rel="noopener noreferrer">
    <Button>Germany</Button>
  </a>
  <a onClick={() => umami.track('Farewell to Westphalia  - Australia', { source: '/farewell-to-westphalia-1' })} href="https://www.booktopia.com.au/farewell-to-westphalia-jarrad-hope/book/9783952627518.html?srsltid=AfmBOoocXlueFUh3mIjkSAdN_FL_o0zW6WKukx4C_csNtgGNjp_iTqoX" target="_blank" rel="noopener noreferrer">
