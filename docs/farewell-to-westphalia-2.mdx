...
<img
  src="/assets/farewell-to-westphalia-wide-80.png"
...
### Available now
<span style={{ display: 'block', height: 'calc(var(--ifm-heading-vertical-rhythm-bottom) * var(--ifm-leading))' }} />
<div className='ftw-links'>
  <a onClick={() => umami.track('Farewell to Westphalia  - Amazon', { source: '/farewell-to-westphalia-2' })} href="https://www.amazon.com/Farewell-Westphalia-Sovereignty-Post-Nation-State-Governance/dp/B0FQLV79ZN/ref=tmm_pap_swatch_0" target="_blank" rel="noopener noreferrer">
    <Button>Amazon</Button>
  </a>
  <a onClick={() => umami.track('Farewell to Westphalia  - Open source (free)', { source: '/farewell-to-westphalia-2' })} href="/assets/Farewell to Westphalia (Jarrad Hope and Peter Ludlow) - FOSS edition.pdf" target="_blank" rel="noopener noreferrer">
