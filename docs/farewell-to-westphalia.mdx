...
It explores the shortcomings of the nation state, presenting sovereign cyberstates and network states as an alternative order for the post-Westphalian era. Physical and e-reader editions of the book will be available for purchase in early 2025 but a version will also be made freely available – because ideas should never be caged behind a paywall.


For updates on *Farewell to Westphalia*, subscribe to the newsletter below and follow [Jarrad's personal profile](https://x.com/jarradhope_) and [Logos](https://x.com/Logos_network) on X.
