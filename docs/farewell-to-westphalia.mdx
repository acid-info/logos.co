...
For updates on *Farewell to Westphalia*, subscribe to the newsletter below and follow us on X.

<div className="ftw-labels">
  <a href="#ftw-form">Newsletter</a>
  <a href="https://x.com/Logos_network" target='_blank'>Logos</a>
  <a href="https://x.com/jarradhope_" target='_blank'>Jarrad's personal profile</a>
</div>

<br />

## A blueprint for a social order built on blockchain
...
If these ideas speak to you, please consider signing up for email updates about *Farewell to Westphalia*, including preorder and publication date details, using the form below.
