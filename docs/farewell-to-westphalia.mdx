...
It explores the shortcomings of the nation state, presenting sovereign cyberstates and network states as an alternative order for the post-Westphalian era. Physical and e-reader editions of the book will be available for purchase in September 2025, but a version will also be made freely available – because ideas should never be caged behind a paywall.

For updates on *Farewell to Westphalia*, subscribe to the newsletter below and follow [Logos](https://x.com/Logos_network) and [Jarrad](https://x.com/jarradhope_) on X. For publishing enquiries, email team@acid.info.
...
If these ideas speak to you, please consider signing up for email updates about *Farewell to Westphalia*, including publication date details, using the form above.
