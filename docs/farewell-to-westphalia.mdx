...
<div className="ftw-labels">
  ...
  <a href="https://x.com/jarradhope_" target='_blank'>Jarrad Hope</a>
</div>
...
#### In making the case for blockchain governance, <br/> the authors considers:  
...
<InputCTASection
    ...
    buType={'logos'}
    newsletterId="675af2e4deb47200012e22c4"
/>
</div>
