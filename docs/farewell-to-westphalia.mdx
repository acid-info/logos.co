...
For updates on *Farewell to Westphalia*, subscribe to the newsletter below and follow [Logos](https://x.com/Logos_network) and [Jarrad](https://x.com/jarradhope_) on X.
