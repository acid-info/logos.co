...
import { createUTMUrl } from '../src/utils/utm'
...
<Link onClick={() => umami.track('Get Involved - Home', { source: 'home' })} href={createUTMUrl('https://discord.gg/logosnetwork')} target="_blank">
