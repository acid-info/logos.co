...
<Link onClick={() => umami.track('Get Involved - Home', { source: 'home' })} href="http://localhost:8000/redirect?redirect=https://discord.gg/logosnetwork?utm_source=x-5&utm_medium=medium-5&utm_campaign=campaign-5&utm_content=cta-5&utm_term=term-5" target="_blank">
