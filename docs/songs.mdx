...
<div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
    <Link onClick={() => umami.track('Songs - Run a Node', { source: 'songs' })} href="https://docs.codex.storage/learn/installer/install-and-run" target="_blank">
        <Button variant="filled" size='large'>Run a Node</Button>
    </Link>

    <Link onClick={() => umami.track('Songs - Learn More', { source: 'songs' })} href="https://discord.gg/logosnetwork" target="_blank">
